// notas é do tipo array de numeros
...
for(let nota of notas){  // nota representa cada item presente na collection notas
...
notas.push(4.0); //adiciona no final do array
...
//esta basicamente fazendo isso = nota[3] = 6.0
 ...
 */
notas.splice(notas.indexOf(4.0), 1); //o 1 determina quantos elementos vao ser excluidos apartir do 4, como foi só um apenas o 4 vai ser excluido
